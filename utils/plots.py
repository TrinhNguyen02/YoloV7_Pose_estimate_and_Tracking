...
def plot_one_box_kpt(x, im, color=None, label=None, line_thickness=3, kpt_label=False, kpts=None, steps=2, orig_shape=None, conf = None, cls=None, names = None, sort_tracker =None, rand_color_list =None, tracks =None , tracked_dets =None):
    ...
    for track in tracks:
        ...
        [cv2.line(im, (int(track.centroidarr[i][0]),
    ...
    if len(tracked_dets)>0:
        ...
        draw_boxes(im, bbox_xyxy, identities, categories, names)
        #........................................................
